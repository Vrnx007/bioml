  ...
  return (
    <div className="border-b border-border bg-surface-page py-12 sm:py-16">
      <div className="ui-container max-w-3xl">
        ...
        <p className="mt-3 max-w-2xl text-base leading-relaxed text-text-secondary">{t("lead")}</p>
        ...
        {sp.rfq && (
          <section className="mt-8 rounded-card border border-accent-teal/30 bg-accent-subtle/40 p-6 sm:p-8">
            ...
            <p className="mt-3 text-base leading-relaxed text-text-secondary">
              Product: <strong className="text-text-primary">{sp.product ?? "—"}</strong>. Wire this flow to{" "}
              <code className="rounded bg-surface-elevated px-1.5 py-0.5 font-mono text-sm">rfqs</code> in production.
            </p>
          </section>
        )}
      </div>
